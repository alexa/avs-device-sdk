...
#ifndef ALEXA_CLIENT_SDK_INTEGRATION_INCLUDE_INTEGRATION_TESTAUTHDELEGATE_H_
#define ALEXA_CLIENT_SDK_INTEGRATION_INCLUDE_INTEGRATION_TESTAUTHDELEGATE_H_
...
#endif /* ALEXA_CLIENT_SDK_INTEGRATION_INCLUDE_INTEGRATION_TESTAUTHDELEGATE_H_ */
