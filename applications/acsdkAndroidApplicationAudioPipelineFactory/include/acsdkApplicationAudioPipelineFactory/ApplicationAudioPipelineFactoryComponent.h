...
/**
 * Definition of a Manufactory Component for the Android implementation of @c ApplicationAudioPipelineFactoryInterface.
 */
using AndroidApplicationAudioPipelineFactoryComponent = acsdkManufactory::Component<
