...
AndroidApplicationAudioPipelineFactory::createApplicationAudioPipelineFactoryInterface(
    ...
    return std::shared_ptr<AndroidApplicationAudioPipelineFactory>(new AndroidApplicationAudioPipelineFactory(
...
std::shared_ptr<avsCommon::sdkInterfaces::ApplicationMediaInterfaces> AndroidApplicationAudioPipelineFactory::
...
AndroidApplicationAudioPipelineFactory::createPooledApplicationMediaInterfaces(
    const std::string& name,
    int numMediaPlayers,
    bool equalizerAvailable,
    bool enableLiveMode,
...
AndroidApplicationAudioPipelineFactory::AndroidApplicationAudioPipelineFactory(
