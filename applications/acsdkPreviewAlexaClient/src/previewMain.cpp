...
using namespace alexaClientSDK::acsdkPreviewAlexaClient;
...
int main(int argc, char* argv[]) {
    ...
    std::unique_ptr<PreviewAlexaClient> application;
    ...
    do {
        ...
        if (!application) {
            ConsolePrinter::simplePrint("Failed to create PreviewAlexaClient!");
            return SampleAppReturnCode::ERROR;
        }
