...
/**
 * Definition of a Manufactory Component for the Custom implementation of @c ApplicationAudioPipelineFactoryInterface.
 */
using CustomApplicationAudioPipelineFactoryComponent = acsdkManufactory::Component<
 ...
 * @return A component.
 */
CustomApplicationAudioPipelineFactoryComponent getComponent();
