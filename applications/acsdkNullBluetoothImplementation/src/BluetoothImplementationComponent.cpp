...
BluetoothImplementationComponent getComponent() {
    return acsdkManufactory::ComponentAccumulator<>()
        .addInstance<std::shared_ptr<avsCommon::sdkInterfaces::bluetooth::BluetoothDeviceManagerInterface> >(nullptr)
        .addInstance<std::shared_ptr<avsCommon::utils::bluetooth::BluetoothEventBus> >(nullptr);
}
