...
NotificationsComponent getComponent() {
    return acsdkManufactory::ComponentAccumulator<>()
        .addRetainedFactory(NotificationRenderer::createNotificationRendererInterface)
        .addRetainedFactory(NotificationsNotifier::createNotificationsNotifierInterface)
        .addRequiredFactory(NotificationsCapabilityAgent::createNotificationsCapabilityAgent);
}
