...
struct NotificationIndicator {
     ...
     * Constructor
     *
     * @param persistVisualIndicator A flag indicating whether the visual
     * indicator on the device should stay lit.
    ...
    /**
     * Flag specifying if the device must display a persistent visual indicator
     * when processing this
     * @c NotificationIndicator.
     */
    bool persistVisualIndicator;

    /// Flag specifying if the device must play audio when processing this @c
    /// NotificationIndicator.
    bool playAudioIndicator;
    ...
    struct Asset {
        ...
        /** The location of the sound to be played when this @c
         * NotificationIndicator is processed.
         *  @note If the device is offline the device should play the default
         * indicator sound.
         */
        std::string url;
    } asset;
...
#endif  // ACSDKNOTIFICATIONS_NOTIFICATIONINDICATOR_H_
