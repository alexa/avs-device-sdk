...
class NotificationsCapabilityAgent
        : public acsdkNotificationsInterfaces::NotificationRendererObserverInterface
...
private:
    ...
    std::shared_ptr<acsdkNotificationsInterfaces::NotificationsStorageInterface> m_notificationsStorage;
    ...
    std::shared_ptr<acsdkNotificationsInterfaces::NotificationRendererInterface> m_renderer;
...
#endif  // ACSDKNOTIFICATIONS_NOTIFICATIONSCAPABILITYAGENT_H_
