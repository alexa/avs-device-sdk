...
private:
    ...
    /**
     * Same as @c pause(), but may be called with @c m_callMutex already held
     */
    void pauseLocked();

    /**
     * Same as @c resume(), but may be called with @c m_callMutex already held
     */
    void resumeLocked();
...
#endif  // ACSDKAUDIOPLAYER_PROGRESSTIMER_H_
