...
std::shared_ptr<EqualizerConfigurationInterface> SDKConfigEqualizerConfiguration::createEqualizerConfigurationInterface(
    const std::shared_ptr<ConfigurationNode>& configRoot) {
    auto configPtr = *configRoot;
    auto equalizerConfigBranch = configPtr[EQUALIZER_CONFIG_KEY];
    return create(equalizerConfigBranch);
}
