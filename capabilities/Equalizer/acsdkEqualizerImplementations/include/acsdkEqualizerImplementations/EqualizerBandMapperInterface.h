...
#ifndef ACSDKEQUALIZERIMPLEMENTATIONS_EQUALIZERBANDMAPPERINTERFACE_H_
#define ACSDKEQUALIZERIMPLEMENTATIONS_EQUALIZERBANDMAPPERINTERFACE_H_
...
public:
    ...
    virtual void mapEqualizerBands(
        const acsdkEqualizerInterfaces::EqualizerBandLevelMap& bandLevelMap,
...
#endif  // ACSDKEQUALIZERIMPLEMENTATIONS_EQUALIZERBANDMAPPERINTERFACE_H_
