...
/**
 * BlueZ implementation of @c SPPInterface interface
 */
class BlueZSPP : public avsCommon::sdkInterfaces::bluetooth::services::SPPInterface {
public:
    /**
     * Factory method to create a new instance of @c BlueZSPP
     *
     * @return A new instance of @c BlueZSPP, nullptr if there was an error creating it.
     */
...
private:
    ...
    std::shared_ptr<avsCommon::utils::bluetooth::SPPRecord> m_record;
};
...
#endif  // ALEXA_CLIENT_SDK_BLUETOOTHIMPLEMENTATIONS_BLUEZ_INCLUDE_BLUEZ_BLUEZSPP_H_App