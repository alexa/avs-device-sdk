...
int main(int argc, char** argv) {
    ...
    auto webApplication =
        alexaClientSDK::webExtension::WebApplication::create(pathToConfig, pathToInputFolder, logLevel);
    if (!webApplication) {
        alexaClientSDK::webExtension::ConsolePrinter::simplePrint("Failed to create to webApplication!");
        return EXIT_FAILURE;
    }
