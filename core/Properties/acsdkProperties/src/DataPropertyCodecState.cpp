...
#include <acsdkProperties/private/DataPropertyCodecState.h>
...
/// @private
static const std::string TAG{"DataPropertyCodecState"};
...
bool DataPropertyCodecState::decode(const DataBlock& der) noexcept {
    ...
    m_asn1Data = d2i_ACSDK_DATA_PROP(nullptr, &data, der.size());
