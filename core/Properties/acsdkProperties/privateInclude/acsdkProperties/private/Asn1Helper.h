...
#ifndef ACSDKPROPERTIES_PRIVATE_ASN1HELPER_H_
#define ACSDKPROPERTIES_PRIVATE_ASN1HELPER_H_
...
using acsdkCryptoInterfaces::AlgorithmType;
using acsdkCryptoInterfaces::DigestType;
...
#endif  // ACSDKPROPERTIES_PRIVATE_ASN1HELPER_H_
