...
#ifndef ACSDKPROPERTIES_PRIVATE_MISCSTORAGEPROPERTIES_H_
#define ACSDKPROPERTIES_PRIVATE_MISCSTORAGEPROPERTIES_H_
 ...
 *
 * @see alexaClientSDK::acsdkPropertiesInterfaces::PropertiesInterface
 * @see alexaClientSDK::avsCommon::sdkInterfaces::storage::MiscStorageInterface
 *
 * @ingroup PropertiesIMPL
 */
class MiscStorageProperties : public alexaClientSDK::acsdkPropertiesInterfaces::PropertiesInterface {
public:
    /**
...
#endif  // ACSDKPROPERTIES_PRIVATE_MISCSTORAGEPROPERTIES_H_
