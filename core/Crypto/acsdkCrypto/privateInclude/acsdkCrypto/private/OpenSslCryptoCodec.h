...
#ifndef ACSDKCRYPTO_PRIVATE_OPENSSLCRYPTOCODEC_H_
#define ACSDKCRYPTO_PRIVATE_OPENSSLCRYPTOCODEC_H_
...
using alexaClientSDK::acsdkCryptoInterfaces::CryptoCodecInterface;
...
#endif  // ACSDKCRYPTO_PRIVATE_OPENSSLCRYPTOCODEC_H_
