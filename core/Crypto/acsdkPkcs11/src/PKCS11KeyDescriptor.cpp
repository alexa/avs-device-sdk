...
#include <acsdkPkcs11/private/PKCS11KeyDescriptor.h>
...
/// @private
static const std::string TAG{"pkcs11::KeyDescriptor"};
...
bool equal_to<alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor>::operator()(
...
std::size_t hash<alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor>::operator()(
    const alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor& arg) const noexcept {
