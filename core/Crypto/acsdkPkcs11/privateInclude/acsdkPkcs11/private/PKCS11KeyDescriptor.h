...
#ifndef ACSDKPKCS11_PRIVATE_PKCS11KEYDESCRIPTOR_H_
#define ACSDKPKCS11_PRIVATE_PKCS11KEYDESCRIPTOR_H_

#include <functional>
#include <string>

#include <acsdkCryptoInterfaces/AlgorithmType.h>
#include <acsdkPkcs11/private/PKCS11API.h>
 ...
 */
template <>
struct hash<alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor> {
    /**
     ...
     */
    std::size_t operator()(const alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor& arg) const noexcept;
};
 ...
 */
template <>
struct equal_to<alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor> {
    /**
     ...
     */
    bool operator()(
        const alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor& arg1,
        const alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor& arg2) const noexcept;
};

// Dumps PKCS11KeyDescriptor data into stream (for logging).
std::ostream& operator<<(std::ostream& out, const alexaClientSDK::acsdkPkcs11::PKCS11KeyDescriptor& arg) noexcept;

}  // namespace std

#endif  // ACSDKPKCS11_PRIVATE_PKCS11KEYDESCRIPTOR_H_
