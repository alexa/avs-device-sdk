 ...
 * @private
 * @ingroup CryptoPKCS11Stubs
 */
#define LX(event) alexaClientSDK::avsCommon::utils::logger::LogEntry(TAG, event)

/// @addtogroup CryptoPKCS11Stubs
/// @{
...
/// @private
static const std::string TAG{"pkcs11:HSMStub"};
...
CK_RV C_Initialize(CK_VOID_PTR reserved) {
    ...
    std::unique_lock<std::mutex> sessionLock(c_sessionsMutex);
    c_cryptoFactory = alexaClientSDK::acsdkCrypto::createCryptoFactory();
