...
std::shared_ptr<avsCommon::sdkInterfaces::CallManagerInterface> ExternalCapabilitiesBuilder::getCallManager() {
#ifdef ENABLE_COMMS
...
std::pair<
    ...
    std::list<std::shared_ptr<avsCommon::utils::RequiresShutdown>>>
ExternalCapabilitiesBuilder::buildCapabilities(
    ...
    std::list<std::shared_ptr<avsCommon::utils::RequiresShutdown>> requireShutdownObjects;
...
defaultClient::ExternalCapabilitiesBuilderInterface& ExternalCapabilitiesBuilder::withAlexaInterfaceMessageSender(
