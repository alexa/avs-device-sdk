...
using namespace alexaClientSDK::sampleApplications::ipcServerSampleApp;
...
int main(int argc, char* argv[]) {
    ...
    ConsolePrinter::simplePrint("SDK Version " + avsCommon::utils::sdkVersion::getCurrentVersion());
