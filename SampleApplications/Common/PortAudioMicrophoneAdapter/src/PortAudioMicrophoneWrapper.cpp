...
static const auto SAMPLE_APP_CONFIG_ROOT_KEY = "sampleApp";
static const auto PORTAUDIO_CONFIG_ROOT_KEY = "portAudio";
static const auto PORTAUDIO_CONFIG_SUGGESTED_LATENCY_KEY = "suggestedLatency";

/// String to identify log entries originating from this file.
#define TAG "PortAudioMicrophoneWrapper"
...
bool PortAudioMicrophoneWrapper::getConfigSuggestedLatency(PaTime& suggestedLatency) {
    ...
    auto config = avsCommon::utils::configuration::ConfigurationNode::getRoot()
                      .getChildNode(SAMPLE_APP_CONFIG_ROOT_KEY)
                      .getChildNode(PORTAUDIO_CONFIG_ROOT_KEY);
    if (config) {
