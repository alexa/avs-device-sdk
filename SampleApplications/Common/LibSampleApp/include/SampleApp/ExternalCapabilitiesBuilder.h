...
#ifndef SAMPLEAPP_EXTERNALCAPABILITIESBUILDER_H_
#define SAMPLEAPP_EXTERNALCAPABILITIESBUILDER_H_
...
public:
    ...
    ExternalCapabilitiesBuilder& withAlexaInterfaceMessageSender(
...
private:
    ...
    /// Message Sender for Response events on Alexa Interface
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::AlexaInterfaceMessageSenderInterface>
...
#endif  // SAMPLEAPP_EXTERNALCAPABILITIESBUILDER_H_
