...
#ifndef CBLAUTHDELEGATE_CBLAUTHDELEGATE_H_
#define CBLAUTHDELEGATE_CBLAUTHDELEGATE_H_
 ...
 * @see https://developer.amazon.com/en-US/docs/alexa/alexa-voice-service/authorize-cbl.html
 */
...
#endif  // CBLAUTHDELEGATE_CBLAUTHDELEGATE_H_
