...
private:
     ...
     */
    void executeSetObserver(RendererObserverInterface* observer);
     ...
     */
    void executeOnPlaybackError(const avsCommon::utils::mediaPlayer::ErrorType& type, const std::string& error);
