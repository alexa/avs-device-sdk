...
/**
 * @brief Storage state for SpeakerManager.
 *
 * SpeakerManager configuration includes configuration for two channel types: speaker and alerts. There can be any
 * number of channels for each of types, but all of them share the same configuration.
 *
