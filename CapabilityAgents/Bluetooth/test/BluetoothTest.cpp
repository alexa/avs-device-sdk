...
#include <AVSCommon/SDKInterfaces/Bluetooth/MockBluetoothDeviceObserver.h>
...
void BluetoothTest::SetUp() {
    ...
    m_mockBluetoothDeviceObserver = std::make_shared<NiceMock<MockBluetoothDeviceObserver>>();
