...
std::shared_ptr<RenderPlayerInfoCardsProviderRegistrarInterface> RenderPlayerInfoCardsProviderRegistrar::
    createRenderPlayerInfoCardsProviderRegistrarInterface() {
    std::shared_ptr<RenderPlayerInfoCardsProviderRegistrar> registrar(new RenderPlayerInfoCardsProviderRegistrar());
    return registrar;
}
...
RenderPlayerInfoCardsProviderRegistrar::RenderPlayerInfoCardsProviderRegistrar() = default;
