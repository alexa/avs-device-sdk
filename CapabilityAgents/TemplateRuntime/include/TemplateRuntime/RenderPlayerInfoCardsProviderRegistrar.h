...
#ifndef ALEXA_CLIENT_SDK_CAPABILITYAGENTS_TEMPLATERUNTIME_INCLUDE_TEMPLATERUNTIME_RENDERPLAYERINFOCARDSPROVIDERREGISTRAR_H_
...
public:
    /**
     * Create a new instance of @c RenderPlayerInfoCardsProviderRegistrar.
     *
     * @return A new instance of @c PostConnectOperationProviderRegistrar.
     */
    static std::shared_ptr<avsCommon::sdkInterfaces::RenderPlayerInfoCardsProviderRegistrarInterface>
