...
private:
     ...
     */
    void sendStreamMetadataExtractedEvent(const std::string& token, std::shared_ptr<const VectorOfTags> vectorOfTags);
    ...
    /// MediaPlayerFactoryInterface instance ised to generate Players used to play tracks.
