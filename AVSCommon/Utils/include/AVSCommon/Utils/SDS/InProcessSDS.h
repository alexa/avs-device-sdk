...
#ifndef ALEXA_CLIENT_SDK_AVSCOMMON_INCLUDE_AVSCOMMON_UTILS_SDS_IN_PROCESS_SDS_H_
#define ALEXA_CLIENT_SDK_AVSCOMMON_INCLUDE_AVSCOMMON_UTILS_SDS_IN_PROCESS_SDS_H_
...
#endif // ALEXA_CLIENT_SDK_AVSCOMMON_INCLUDE_AVSCOMMON_UTILS_SDS_IN_PROCESS_SDS_H_
