...
#ifndef ALEXA_CLIENT_SDK_AVS_COMMON_INCLUDE_AVS_COMMON_AVS_EXCEPTION_H_
#define ALEXA_CLIENT_SDK_AVS_COMMON_INCLUDE_AVS_COMMON_AVS_EXCEPTION_H_
...
#endif // ALEXA_CLIENT_SDK_AVS_COMMON_INCLUDE_AVS_COMMON_AVS_EXCEPTION_H_
