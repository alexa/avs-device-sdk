 ...
 */
#ifndef ALEXA_CLIENT_SDK_AVSCOMMON_SDKINTERFACES_INCLUDE_AVSCOMMON_SDKINTERFACES_AUDIOFOCUSANNOTATION_H_
...
/**
 * Annotation for audio-related focus implementations.
 */
