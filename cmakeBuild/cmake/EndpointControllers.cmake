...
if(ENABLE_ALL_ENDPOINT_CONTROLLERS)
     ...
     cmake_dependent_option(ENDPOINT_CONTROLLERS_INPUT_CONTROLLER "Enable endpoint controller Input Controller capability" ON "ENABLE_ALL_ENDPOINT_CONTROLLERS" OFF)
endif()
...
if(ENDPOINT_CONTROLLERS_INPUT_CONTROLLER)
     message("Creating ${PROJECT_NAME} with Input Controller capability")
     add_definitions(-DINPUT_CONTROLLER)
endif()

if(ENDPOINT_CONTROLLERS_POWER_CONTROLLER OR ENDPOINT_CONTROLLERS_TOGGLE_CONTROLLER OR
     ENDPOINT_CONTROLLERS_RANGE_CONTROLLER OR ENDPOINT_CONTROLLERS_MODE_CONTROLLER OR
     ENDPOINT_CONTROLLERS_INPUT_CONTROLLER)
     add_definitions(-DENABLE_ENDPOINT_CONTROLLERS)
endif()
